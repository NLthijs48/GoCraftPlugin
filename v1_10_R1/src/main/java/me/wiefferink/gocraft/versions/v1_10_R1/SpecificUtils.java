package me.wiefferink.gocraft.versions.v1_10_R1;

import com.comphenix.protocol.wrappers.*;
import com.mojang.authlib.GameProfile;
import me.wiefferink.gocraft.interfaces.SpecificUtilsBase;
import me.wiefferink.gocraft.versions.v1_10_R1.packetwrapper.WrapperPlayServerNamedEntitySpawn;
import me.wiefferink.gocraft.versions.v1_10_R1.packetwrapper.WrapperPlayServerPlayerInfo;
...
public class SpecificUtils extends SpecificUtilsBase {
	...
	public ItemStack addGlow(ItemStack item) {
		...
		if (tag == null) { // Failed, return original item
			return item;
		}
		tag.set("ench", ench);
		nmsStack.setTag(tag);
	...
	public int sendFakePlayer(Location location, Player player, boolean visible, String name) {
		...
		WrappedDataWatcher.WrappedDataWatcherObject sixOject = new WrappedDataWatcher.WrappedDataWatcherObject(7, floatSerializer);
